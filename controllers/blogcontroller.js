...
exports.getPendingBlogs = async (req, res) => {
    try {
      ...
      res.status(500).json({ message: 'Error fetching review blogs', error: error.message });
    }
  };
  ...
  exports.getReviewedBlogs = async (req, res) => {
    try {
      ...
      res.status(500).json({ message: 'Error fetching reviewed blogs', error: error.message });
    }
  };
